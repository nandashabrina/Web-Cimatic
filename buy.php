      ...
      <div class="row row-transaction">
        ...
        <div class="col-lg-8 mt-3">
          ...
          <div class="btn-display-method btn-display-transaction">
            <a href="buyProcess.php?id=<?php echo $row["id"];?>&price=<?php echo $row["hrgBeli"];?>&link=<?php echo $row["link"];?>" class="btn btn-buy">Beli Rp<?php echo $row["hrgBeli"]; ?></a>
            <a class="btn btn-addWish-transaction" href="buyProcess.php?id=<?php echo $row["id"];?>&price=<?php echo $row["hrgSewa"];?>&link=<?php echo $row["link"];?>" role="button">
