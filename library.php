  ...
  <nav class="navbar navbar-expand-lg navbar-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item underL">
            <a class="nav-link nav-custom status-active" href="#">Library</a>
          </li>
          <li class="nav-item underL">
...
<section class="movie-list container mb-5">
    <h1 class="header mt-5 mb-3">My Library</h1>
    <div class="movie-container">
    <?php
      include "connection.php";
      $id = $_SESSION["user"];
      $query = "SELECT f.id, f.judul, f.genre, f.tglRilis, f.ratingAge, f.hrgSewa, f.hrgBeli, f.img, f.poster, f.deskripsi, f.link, f.stat FROM library lb INNER JOIN film f ON lb.idFilm = f.id WHERE lb.idUser = '$id'";
      ...
      if(mysqli_num_rows($result) > 0){
        ...
        <div class="box-wrapper-library">
          <div class="box">
            ...
            <a class="watch" href="https://www.youtube.com/watch?v=<?php echo $row["link"]; ?>" role="button">
              <p>Watch</p> 
            </a>
          </div>
        </div>
