...
<section class="movie-list container mb-5 movie-container-search">
  <h1 class="header mt-5 mb-3">Search result "<span class="search"><?php echo $_POST['seachTitle']?></span></span>"</h1>
  <div class="movie-container">
    <?php
      $title = $_POST['seachTitle'];
      include "dashboard/connection.php";

      $query = "SELECT * FROM film WHERE judul LIKE '%$title%'";
