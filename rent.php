      ...
      <div class="row row-transaction">
        ...
        <div class="col-lg-8 mt-3">
          ...
          <div class="btn-display-method btn-display-transaction">
            <a href="rentProcess.php?id=<?php echo $row["id"];?>&price=<?php echo $row["hrgSewa"];?>&link=<?php echo $row["link"];?>" class="btn btn-rent">Sewa Rp<?php echo $row["hrgBeli"]; ?></a>
            <a class="btn btn-addWish-transaction" href="addWishlist.php?id=<?php echo $row["id"];?>" role="button">
