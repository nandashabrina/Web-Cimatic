            ...
            <div class="carosel_content  h-100 container position-relative">
              <div class="position-absolute top-50 start-0 translate-middle-y">
                ...
                <div class="btn-display-method btn-preview-position-custom">
                    <a class="btn btn-custom-buy" href="wishlistBuy.php?id=<?php echo $row["id"];?>" role="button">Beli Rp<?php echo $row["hrgBeli"]; ?></a>
                    <a class="btn btn-custom-rent" href="wishlistRent.php?id=<?php echo $row["id"];?>" role="button">Sewa Rp<?php echo $row["hrgSewa"]; ?></a>
                </div>
            </div>
          </div>
        </div>
...
<div class="container">
  <div class="row g-5">
    ...
    <div class="col-md-4">
      <div class="position-sticky-custom" style="top: 2rem;">
        <div class="p-5 mb-3">
          ...
          <div class="movie-container">
            <?php
              ...
              if($row["stat"] == 2 && $row["genre"] == $genre && $row["id"] != $id){?>
