  ...
  <nav class="navbar navbar-expand-lg navbar-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item underL">
            <a class="nav-link nav-custom status-active" href="#">Wishlist</a>
          </li>
          <li>
...
<section class="movie-list container mb-5">
    <h1 class="header mt-5 mb-3">Wishlist</h1>
    <div class="movie-container">
    <?php
      include "connection.php";
      $id = $_SESSION["user"];
      $query = "SELECT f.id, f.judul, f.genre, f.tglRilis, f.ratingAge, f.hrgSewa, f.hrgBeli, f.img, f.poster, f.deskripsi, f.link, f.stat FROM wishlist wh INNER JOIN film f ON wh.idFilm = f.id WHERE wh.idUser = $id";
      ...
      if(mysqli_num_rows($result) > 0){
          while($row = mysqli_fetch_array($result)){
            ...
            <?php }else{?>
              <a href="wishlistTransaction.php?id=<?php echo $row["id"];?>" class="box-wrapper">
              <div class="box">
                <div class="box-img">
                  <img src="img/<?php echo $row["poster"]; ?>" alt="">
                </div>
